...
_ARABIC_TO_ENGLISH = {
    ...
    # Zero-recall terms - expanded for missing queries
    "فشل القلب": "heart failure",
    "القلب يفشل": "heart failure",
    ...
    "العدوى المسالك البولية": "urinary tract infection",
    "التهاب المسالك": "urinary tract infection",
    "أمراض الغدة الدرقية": "thyroid disease",
    "أعراض الغدة الدرقية": "thyroid disease symptoms",
    "ارتفاع ضغط الدم": "high blood pressure",
    "أعراض ارتفاع ضغط الدم": "high blood pressure symptoms",
    "كثرة السكريات": "excessive sugar",
    "أضرار السكريات": "health harms of sugar",
